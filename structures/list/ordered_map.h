...
struct ordered_map {
  ...
  ordered_map() : root(node_pool.new_obj(node_pool.new_obj(nullptr,true),false)) {}
  ordered_map(size_t n) : root(node_pool.new_obj(node_pool.new_obj(nullptr,true),false)) {}
